...
fondo_menu = pygame.image.load("mm/img.jpg")
fondo_menu = pygame.transform.scale(fondo_menu, (ancho, alto))

ancho_botones = 300
alto_botones = 100

boton_inicio_img = pygame.image.load("mm/boton inicio.png")
boton_inicio_img = pygame.transform.scale(boton_inicio_img, (ancho_botones, alto_botones))
boton_config_img = pygame.image.load("mm/boton configuracion.png")
